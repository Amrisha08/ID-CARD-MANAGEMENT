...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM form WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update form set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<head>
    ...
    <title>Online ID Card Management System | Password Recovery </title>
